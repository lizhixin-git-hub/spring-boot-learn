...
import com.lzx.distributed.lock.download.Downloader;
import com.lzx.distributed.lock.download.MultiThreadFileDownloader;
import com.lzx.distributed.lock.support.MultiThreadDownloadProgressPrinter;
...
/**
 * 文件断点续传下载
 * https://mp.weixin.qq.com/s/_4OuD-RqO_fFIpogiZN-uw
...
public class FastDownloadApplication {
   ...
   public static void main(String[] args) throws IOException {
      ...
      //downloader.download(fileURL, "/Users/huaan9527/Desktop");
      //fileDownloader.downloadFile(fileURL, "/Users/huaan9527/Desktop/ideaIU-2020.3.dmg");
      ...
      downloader.download(fileURL, "C:\\Users\\Administrator.DESKTOP-B3T0660.000\\Desktop\\备份文件\\");
