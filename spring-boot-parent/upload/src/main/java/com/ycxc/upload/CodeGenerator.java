...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String packageProject = "upload";
        // 全局配置
        GlobalConfig gc = new GlobalConfig();
        String projectPath = System.getProperty("user.dir");
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("hack2003");
        //是否覆盖已有文件
        ...
        dsc.setUrl("jdbc:mysql://192.168.1.11:3306/ycxc_nn_db?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("developer");
        dsc.setPassword("developer123456");
        ...
        pc.setMapper("mapper."+packagefunction);
        pc.setXml("mapper");
